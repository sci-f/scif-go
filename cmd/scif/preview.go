...
func init() {
	PreviewCmd.Flags().SetInterspersed(false)
...
var PreviewCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// recipe string, apps []string
		client.Preview(recipe, args)
	},

	Use:     docs.PreviewUse,
	Short:   docs.PreviewShort,
	Long:    docs.PreviewLong,
	Example: docs.PreviewExample,
}
